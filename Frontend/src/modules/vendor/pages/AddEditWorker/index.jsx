                ...
                <React.Fragment>
                  ...
                  <div className="absolute z-20 w-full mt-1 bg-white rounded-xl shadow-xl border border-gray-100 max-h-52 overflow-y-auto p-1.5">
                    {categories.length > 0 ? (
                      ...
                      <div className="px-3 py-3 text-gray-400 text-[10px] text-center space-y-1">
                        <p className="font-bold">No opted services found in portfolio</p>
                        <button
                          type="button"
                          onClick={(e) => { e.preventDefault(); navigate('/vendor/my-services'); }}
                          className="text-blue-600 font-bold underline uppercase tracking-wider"
                        >
