    ...
    <div className="space-y-8 pb-12">
      ...
      <div className="flex items-center gap-2 bg-white p-2 rounded-2xl border border-gray-100 shadow-sm overflow-x-auto scrollbar-hide">
        {[
          ...
          <button
            ...
            className={`
              flex items-center gap-2 px-5 py-2.5 rounded-xl text-xs font-semibold capitalize tracking-widest transition-all duration-300 whitespace-nowrap
              ${filter === tab.id
      ...
      <div className="relative group max-w-2xl">
        ...
        <input
          ...
          className="w-full bg-white border border-gray-200 rounded-2xl py-3.5 pl-12 pr-4 text-xs font-medium text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500/50 transition-all shadow-sm"
        />
      </div>
      ...
      {loading ? (
        ...
        <div className="bg-white rounded-[32px] p-20 text-center border border-gray-100 shadow-sm">
          ...
          <h3 className="text-xl font-normal text-gray-800 mb-2">No Operatives Found</h3>
            ...
            .map((worker) => {
              ...
              return (
                <motion.div
                  ...
                  className="bg-white rounded-3xl p-6 border border-gray-100 shadow hover:shadow-xl transition-all duration-300 relative flex flex-col justify-between overflow-hidden"
                >
                  <div className="flex items-start justify-between gap-4 mb-5">
                    <div className="flex items-center gap-4">
                      <div className="relative">
                        <div className="w-14 h-14 rounded-2xl bg-blue-50 border border-blue-100 flex items-center justify-center text-blue-600 font-bold text-xl uppercase shadow-xs">
                      ...
                      <div className="min-w-0">
                        <div className="flex items-center gap-2">
                          <h3 className="font-bold text-gray-900 text-base truncate">{worker.name}</h3>
                          {worker.rating > 0 && (
                            <span className="flex items-center gap-0.5 text-xs font-bold text-amber-500 bg-amber-50 px-2 py-0.5 rounded-md border border-amber-100/60">
                              <FiStar className="w-3 h-3 fill-amber-400 text-amber-400" />
                              {worker.rating.toFixed(1)}
                            </span>
                          )}
                        </div>
                        <p className="text-xs text-gray-500 font-medium truncate mt-0.5">{worker.phone}</p>
                  ...
                  <div className="flex flex-wrap items-center justify-between pt-5 border-t border-gray-50 gap-3">
                    <div className="flex flex-wrap items-center gap-2">
                      <div className="flex items-center gap-1.5 text-[10px] font-normal capitalize tracking-widest text-blue-600 bg-blue-50 px-2.5 py-1.5 rounded-xl border border-blue-100">
                        <FiBriefcase className="w-3.5 h-3.5" />
                        <span>{worker.completedJobs || 0} Jobs</span>
                      </div>
                      <div className="flex items-center gap-1.5 text-[10px] font-semibold tracking-wide text-emerald-700 bg-emerald-50 px-2.5 py-1.5 rounded-xl border border-emerald-200">
                      ...
                      {isPast ? (
                        ...
                        <>
                          <button
                            ...
                            className={`px-3 py-2 rounded-xl text-[11px] font-bold transition-all flex items-center gap-1 active:scale-95 ${
                          ...
                          <button
                            ...
                            className="px-3 py-2 bg-blue-50 hover:bg-blue-100 text-blue-700 hover:text-blue-800 rounded-xl text-[11px] font-bold border border-blue-200 transition-all flex items-center gap-1 active:scale-95"
                          >
